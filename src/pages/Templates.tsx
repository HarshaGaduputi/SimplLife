...
export function TemplatesPage() {
  ...
  async function confirmApply() {
    ...
    try {
      const created = await api.applyTemplate({
      ...
      try {
        const res = await api.listTasks(applyState.groupId);
  ...
  return (
    <div>
      <section className="container pt-14 lg:pt-20 pb-10">
        ...
        {!user && (
          <div className="mt-6 card max-w-3xl">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h3 className="text-xl" style={{ color: "var(--color-text-strong)" }}>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              {applyState.loadingGroups ? (
                ...
                <div
                  className="rounded-xl p-4 border border-dashed text-sm"
...
function TemplateCard({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl mb-1.5" style={{ color: "var(--color-text-strong)" }}>
        {tpl.name}
      </h3>
